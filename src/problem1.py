...
def run_test_problem1a():
    ...
    # Test 3:
    expected = -0.405  # This is APPROXIMATELY the correct answer.
    answer = problem1a(9, 15)
    print()
...
# Test 1:
    ...
    # Test 3:
    expected = 28  # This is APPROXIMATELY the correct answer.
    answer = problem1b(9, 15)
    print()
    print('Test 3 expected:', expected, '(approximately)')
    print('       actual:  ', answer)

    # Test 4:
    expected = 164  # This is APPROXIMATELY the correct answer.
    answer = problem1b(10, 100)
    print()
    print('Test 4 expected:', expected, '(approximately)')
    print('       actual:  ', answer)
